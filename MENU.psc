...
Funcion notasArreglo(vector,limite)
	...
	res<-suma/limite
	Si res >= 70 Entonces		
		Escribir "Su promedio es ", res
		Escribir "El promedio de notas es mayor a 70 "
	SiNo
		Escribir "Su promedio es ", res
		Escribir "El promedio de notas no es mayor a 70: "
	FinSi
FinFuncion
...
Funcion contar_palabras(letras)
	...
	para pos=1 Hasta lon Con Paso 1 Hacer
		si Subcadena(letras,pos,pos)=" " y Subcadena(letras,pos+1,pos+1)<>" " entonces
			espacios=espacios+1
		FinSi
	FinPara
